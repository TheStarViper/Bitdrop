...
var ASM_CONSTS = {
  113056: () => { if (document.fullscreenElement) return 1; },  
 113102: () => { return document.getElementById('canvas').width; },  
 113154: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113222: () => { document.exitFullscreen(); },  
 113249: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113322: () => { if (document.fullscreenElement) return 1; },  
 113368: () => { return document.getElementById('canvas').width; },  
 113420: () => { return screen.width; },  
 113445: () => { document.exitFullscreen(); },  
 113472: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113605: () => { return window.innerWidth; },  
 113631: () => { return window.innerHeight; },  
 113658: () => { if (document.fullscreenElement) return 1; },  
 113704: () => { return document.getElementById('canvas').width; },  
 113756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113824: () => { if (document.fullscreenElement) return 1; },  
 113870: () => { return document.getElementById('canvas').width; },  
 113922: () => { return screen.width; },  
 113947: () => { return window.innerWidth; },  
 113973: () => { return window.innerHeight; },  
 114000: () => { if (document.fullscreenElement) return 1; },  
 114046: () => { return document.getElementById('canvas').width; },  
 114098: () => { return screen.width; },  
 114123: () => { document.exitFullscreen(); },  
 114150: () => { if (document.fullscreenElement) return 1; },  
 114196: () => { return document.getElementById('canvas').width; },  
 114248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114316: () => { document.exitFullscreen(); },  
 114343: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114401: () => { return screen.width; },  
 114426: () => { return screen.height; },  
 114452: () => { return window.screenX; },  
 114479: () => { return window.screenY; },  
 114506: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114559: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114630: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114687: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114943: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115014: () => { if (document.fullscreenElement) return 1; },  
 115060: () => { return window.innerWidth; },  
 115086: () => { return window.innerHeight; },  
 115113: () => { if (document.pointerLockElement) return 1; }
};
