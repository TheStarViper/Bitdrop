...
var ASM_CONSTS = {
  113136: () => { if (document.fullscreenElement) return 1; },  
 113182: () => { return document.getElementById('canvas').width; },  
 113234: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113302: () => { document.exitFullscreen(); },  
 113329: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113402: () => { if (document.fullscreenElement) return 1; },  
 113448: () => { return document.getElementById('canvas').width; },  
 113500: () => { return screen.width; },  
 113525: () => { document.exitFullscreen(); },  
 113552: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113685: () => { return window.innerWidth; },  
 113711: () => { return window.innerHeight; },  
 113738: () => { if (document.fullscreenElement) return 1; },  
 113784: () => { return document.getElementById('canvas').width; },  
 113836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113904: () => { if (document.fullscreenElement) return 1; },  
 113950: () => { return document.getElementById('canvas').width; },  
 114002: () => { return screen.width; },  
 114027: () => { return window.innerWidth; },  
 114053: () => { return window.innerHeight; },  
 114080: () => { if (document.fullscreenElement) return 1; },  
 114126: () => { return document.getElementById('canvas').width; },  
 114178: () => { return screen.width; },  
 114203: () => { document.exitFullscreen(); },  
 114230: () => { if (document.fullscreenElement) return 1; },  
 114276: () => { return document.getElementById('canvas').width; },  
 114328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114396: () => { document.exitFullscreen(); },  
 114423: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114481: () => { return screen.width; },  
 114506: () => { return screen.height; },  
 114532: () => { return window.screenX; },  
 114559: () => { return window.screenY; },  
 114586: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114639: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114710: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114767: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115023: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115094: () => { if (document.fullscreenElement) return 1; },  
 115140: () => { return window.innerWidth; },  
 115166: () => { return window.innerHeight; },  
 115193: () => { if (document.pointerLockElement) return 1; }
};
