...
var ASM_CONSTS = {
  114112: () => { if (document.fullscreenElement) return 1; },  
 114158: () => { return document.getElementById('canvas').width; },  
 114210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114278: () => { document.exitFullscreen(); },  
 114305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 114378: () => { if (document.fullscreenElement) return 1; },  
 114424: () => { return document.getElementById('canvas').width; },  
 114476: () => { return screen.width; },  
 114501: () => { document.exitFullscreen(); },  
 114528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 114661: () => { return window.innerWidth; },  
 114687: () => { return window.innerHeight; },  
 114714: () => { if (document.fullscreenElement) return 1; },  
 114760: () => { return document.getElementById('canvas').width; },  
 114812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114880: () => { if (document.fullscreenElement) return 1; },  
 114926: () => { return document.getElementById('canvas').width; },  
 114978: () => { return screen.width; },  
 115003: () => { return window.innerWidth; },  
 115029: () => { return window.innerHeight; },  
 115056: () => { if (document.fullscreenElement) return 1; },  
 115102: () => { return document.getElementById('canvas').width; },  
 115154: () => { return screen.width; },  
 115179: () => { document.exitFullscreen(); },  
 115206: () => { if (document.fullscreenElement) return 1; },  
 115252: () => { return document.getElementById('canvas').width; },  
 115304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115372: () => { document.exitFullscreen(); },  
 115399: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 115457: () => { return screen.width; },  
 115482: () => { return screen.height; },  
 115508: () => { return window.screenX; },  
 115535: () => { return window.screenY; },  
 115562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 115615: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 115686: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 115743: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115999: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 116070: () => { if (document.fullscreenElement) return 1; },  
 116116: () => { return window.innerWidth; },  
 116142: () => { return window.innerHeight; },  
 116169: () => { if (document.pointerLockElement) return 1; }
};
