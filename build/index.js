...
var ASM_CONSTS = {
  113120: () => { if (document.fullscreenElement) return 1; },  
 113166: () => { return document.getElementById('canvas').width; },  
 113218: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113286: () => { document.exitFullscreen(); },  
 113313: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113386: () => { if (document.fullscreenElement) return 1; },  
 113432: () => { return document.getElementById('canvas').width; },  
 113484: () => { return screen.width; },  
 113509: () => { document.exitFullscreen(); },  
 113536: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113669: () => { return window.innerWidth; },  
 113695: () => { return window.innerHeight; },  
 113722: () => { if (document.fullscreenElement) return 1; },  
 113768: () => { return document.getElementById('canvas').width; },  
 113820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113888: () => { if (document.fullscreenElement) return 1; },  
 113934: () => { return document.getElementById('canvas').width; },  
 113986: () => { return screen.width; },  
 114011: () => { return window.innerWidth; },  
 114037: () => { return window.innerHeight; },  
 114064: () => { if (document.fullscreenElement) return 1; },  
 114110: () => { return document.getElementById('canvas').width; },  
 114162: () => { return screen.width; },  
 114187: () => { document.exitFullscreen(); },  
 114214: () => { if (document.fullscreenElement) return 1; },  
 114260: () => { return document.getElementById('canvas').width; },  
 114312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114380: () => { document.exitFullscreen(); },  
 114407: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114465: () => { return screen.width; },  
 114490: () => { return screen.height; },  
 114516: () => { return window.screenX; },  
 114543: () => { return window.screenY; },  
 114570: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114623: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114694: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115007: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115078: () => { if (document.fullscreenElement) return 1; },  
 115124: () => { return window.innerWidth; },  
 115150: () => { return window.innerHeight; },  
 115177: () => { if (document.pointerLockElement) return 1; }
};
