...
var ASM_CONSTS = {
  106304: () => { if (document.fullscreenElement) return 1; },  
 106350: () => { return document.getElementById('canvas').width; },  
 106402: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106470: () => { document.exitFullscreen(); },  
 106497: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106570: () => { if (document.fullscreenElement) return 1; },  
 106616: () => { return document.getElementById('canvas').width; },  
 106668: () => { return screen.width; },  
 106693: () => { document.exitFullscreen(); },  
 106720: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106853: () => { return window.innerWidth; },  
 106879: () => { return window.innerHeight; },  
 106906: () => { if (document.fullscreenElement) return 1; },  
 106952: () => { return document.getElementById('canvas').width; },  
 107004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107072: () => { if (document.fullscreenElement) return 1; },  
 107118: () => { return document.getElementById('canvas').width; },  
 107170: () => { return screen.width; },  
 107195: () => { return window.innerWidth; },  
 107221: () => { return window.innerHeight; },  
 ...
 107371: () => { document.exitFullscreen(); },  
 107398: () => { if (document.fullscreenElement) return 1; },  
 107444: () => { return document.getElementById('canvas').width; },  
 107496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107564: () => { document.exitFullscreen(); },  
 107591: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107649: () => { return screen.width; },  
 107674: () => { return screen.height; },  
 107700: () => { return window.screenX; },  
 107727: () => { return window.screenY; },  
 107754: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107807: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107878: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107935: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108191: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108262: () => { if (document.fullscreenElement) return 1; },  
 108308: () => { return window.innerWidth; },  
 108334: () => { return window.innerHeight; },  
 108361: () => { if (document.pointerLockElement) return 1; }
};
