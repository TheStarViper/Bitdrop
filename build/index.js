...
var ASM_CONSTS = {
  112720: () => { if (document.fullscreenElement) return 1; },  
 112766: () => { return document.getElementById('canvas').width; },  
 112818: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112886: () => { document.exitFullscreen(); },  
 112913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 112986: () => { if (document.fullscreenElement) return 1; },  
 113032: () => { return document.getElementById('canvas').width; },  
 113084: () => { return screen.width; },  
 113109: () => { document.exitFullscreen(); },  
 113136: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113269: () => { return window.innerWidth; },  
 113295: () => { return window.innerHeight; },  
 113322: () => { if (document.fullscreenElement) return 1; },  
 113368: () => { return document.getElementById('canvas').width; },  
 113420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113488: () => { if (document.fullscreenElement) return 1; },  
 113534: () => { return document.getElementById('canvas').width; },  
 113586: () => { return screen.width; },  
 113611: () => { return window.innerWidth; },  
 113637: () => { return window.innerHeight; },  
 113664: () => { if (document.fullscreenElement) return 1; },  
 113710: () => { return document.getElementById('canvas').width; },  
 113762: () => { return screen.width; },  
 113787: () => { document.exitFullscreen(); },  
 113814: () => { if (document.fullscreenElement) return 1; },  
 113860: () => { return document.getElementById('canvas').width; },  
 113912: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113980: () => { document.exitFullscreen(); },  
 114007: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114065: () => { return screen.width; },  
 114090: () => { return screen.height; },  
 114116: () => { return window.screenX; },  
 114143: () => { return window.screenY; },  
 114170: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114223: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114294: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114351: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114607: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 114678: () => { if (document.fullscreenElement) return 1; },  
 114724: () => { return window.innerWidth; },  
 114750: () => { return window.innerHeight; },  
 114777: () => { if (document.pointerLockElement) return 1; }
};
