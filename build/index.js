...
var ASM_CONSTS = {
  113072: () => { if (document.fullscreenElement) return 1; },  
 113118: () => { return document.getElementById('canvas').width; },  
 113170: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113238: () => { document.exitFullscreen(); },  
 113265: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113338: () => { if (document.fullscreenElement) return 1; },  
 113384: () => { return document.getElementById('canvas').width; },  
 113436: () => { return screen.width; },  
 113461: () => { document.exitFullscreen(); },  
 113488: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113621: () => { return window.innerWidth; },  
 113647: () => { return window.innerHeight; },  
 113674: () => { if (document.fullscreenElement) return 1; },  
 113720: () => { return document.getElementById('canvas').width; },  
 113772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113840: () => { if (document.fullscreenElement) return 1; },  
 113886: () => { return document.getElementById('canvas').width; },  
 113938: () => { return screen.width; },  
 113963: () => { return window.innerWidth; },  
 113989: () => { return window.innerHeight; },  
 114016: () => { if (document.fullscreenElement) return 1; },  
 114062: () => { return document.getElementById('canvas').width; },  
 114114: () => { return screen.width; },  
 114139: () => { document.exitFullscreen(); },  
 114166: () => { if (document.fullscreenElement) return 1; },  
 114212: () => { return document.getElementById('canvas').width; },  
 114264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114332: () => { document.exitFullscreen(); },  
 114359: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114417: () => { return screen.width; },  
 114442: () => { return screen.height; },  
 114468: () => { return window.screenX; },  
 114495: () => { return window.screenY; },  
 114522: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114575: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114646: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114703: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114959: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115030: () => { if (document.fullscreenElement) return 1; },  
 115076: () => { return window.innerWidth; },  
 115102: () => { return window.innerHeight; },  
 115129: () => { if (document.pointerLockElement) return 1; }
};
