...
var ASM_CONSTS = {
  106192: () => { if (document.fullscreenElement) return 1; },  
 106238: () => { return document.getElementById('canvas').width; },  
 106290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106358: () => { document.exitFullscreen(); },  
 106385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106458: () => { if (document.fullscreenElement) return 1; },  
 106504: () => { return document.getElementById('canvas').width; },  
 106556: () => { return screen.width; },  
 106581: () => { document.exitFullscreen(); },  
 106608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106741: () => { return window.innerWidth; },  
 106767: () => { return window.innerHeight; },  
 106794: () => { if (document.fullscreenElement) return 1; },  
 106840: () => { return document.getElementById('canvas').width; },  
 106892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106960: () => { if (document.fullscreenElement) return 1; },  
 107006: () => { return document.getElementById('canvas').width; },  
 107058: () => { return screen.width; },  
 107083: () => { return window.innerWidth; },  
 107109: () => { return window.innerHeight; },  
 107136: () => { if (document.fullscreenElement) return 1; },  
 107182: () => { return document.getElementById('canvas').width; },  
 107234: () => { return screen.width; },  
 107259: () => { document.exitFullscreen(); },  
 107286: () => { if (document.fullscreenElement) return 1; },  
 107332: () => { return document.getElementById('canvas').width; },  
 107384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107452: () => { document.exitFullscreen(); },  
 107479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107537: () => { return screen.width; },  
 107562: () => { return screen.height; },  
 107588: () => { return window.screenX; },  
 107615: () => { return window.screenY; },  
 107642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108150: () => { if (document.fullscreenElement) return 1; },  
 108196: () => { return window.innerWidth; },  
 108222: () => { return window.innerHeight; },  
 108249: () => { if (document.pointerLockElement) return 1; }
};
