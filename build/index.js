...
var ASM_CONSTS = {
  112672: () => { if (document.fullscreenElement) return 1; },  
 112718: () => { return document.getElementById('canvas').width; },  
 112770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112838: () => { document.exitFullscreen(); },  
 112865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 112938: () => { if (document.fullscreenElement) return 1; },  
 112984: () => { return document.getElementById('canvas').width; },  
 113036: () => { return screen.width; },  
 113061: () => { document.exitFullscreen(); },  
 113088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113221: () => { return window.innerWidth; },  
 113247: () => { return window.innerHeight; },  
 113274: () => { if (document.fullscreenElement) return 1; },  
 113320: () => { return document.getElementById('canvas').width; },  
 113372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113440: () => { if (document.fullscreenElement) return 1; },  
 113486: () => { return document.getElementById('canvas').width; },  
 113538: () => { return screen.width; },  
 113563: () => { return window.innerWidth; },  
 113589: () => { return window.innerHeight; },  
 113616: () => { if (document.fullscreenElement) return 1; },  
 113662: () => { return document.getElementById('canvas').width; },  
 113714: () => { return screen.width; },  
 113739: () => { document.exitFullscreen(); },  
 113766: () => { if (document.fullscreenElement) return 1; },  
 113812: () => { return document.getElementById('canvas').width; },  
 113864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113932: () => { document.exitFullscreen(); },  
 113959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114017: () => { return screen.width; },  
 114042: () => { return screen.height; },  
 114068: () => { return window.screenX; },  
 114095: () => { return window.screenY; },  
 114122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114303: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114559: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 114630: () => { if (document.fullscreenElement) return 1; },  
 114676: () => { return window.innerWidth; },  
 114702: () => { return window.innerHeight; },  
 114729: () => { if (document.pointerLockElement) return 1; }
};
