...
// include: C:\Users\andre\AppData\Local\Temp\tmphpybntqa.js
...
// end include: C:\Users\andre\AppData\Local\Temp\tmphpybntqa.js
// include: C:\Users\andre\AppData\Local\Temp\tmpg9z7c7kx.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\andre\AppData\Local\Temp\tmpg9z7c7kx.js
// include: C:\Users\andre\AppData\Local\Temp\tmp8p_ds9on.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\andre\AppData\Local\Temp\tmp8p_ds9on.js
...
var ASM_CONSTS = {
  146196: () => { if (document.fullscreenElement) return 1; },  
 146242: () => { return document.getElementById('canvas').width; },  
 146294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146362: () => { document.exitFullscreen(); },  
 146389: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 146462: () => { if (document.fullscreenElement) return 1; },  
 146508: () => { return document.getElementById('canvas').width; },  
 146560: () => { return screen.width; },  
 146585: () => { document.exitFullscreen(); },  
 146612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 146745: () => { return window.innerWidth; },  
 146771: () => { return window.innerHeight; },  
 146798: () => { if (document.fullscreenElement) return 1; },  
 146844: () => { return document.getElementById('canvas').width; },  
 146896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146964: () => { if (document.fullscreenElement) return 1; },  
 147010: () => { return document.getElementById('canvas').width; },  
 147062: () => { return screen.width; },  
 147087: () => { return window.innerWidth; },  
 147113: () => { return window.innerHeight; },  
 147140: () => { if (document.fullscreenElement) return 1; },  
 147186: () => { return document.getElementById('canvas').width; },  
 147238: () => { return screen.width; },  
 147263: () => { document.exitFullscreen(); },  
