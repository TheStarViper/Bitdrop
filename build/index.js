...
var ASM_CONSTS = {
 ...
 113314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113382: () => { document.exitFullscreen(); },  
 113409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113482: () => { if (document.fullscreenElement) return 1; },  
 113528: () => { return document.getElementById('canvas').width; },  
 113580: () => { return screen.width; },  
 113605: () => { document.exitFullscreen(); },  
 113632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113765: () => { return window.innerWidth; },  
 113791: () => { return window.innerHeight; },  
 113818: () => { if (document.fullscreenElement) return 1; },  
 113864: () => { return document.getElementById('canvas').width; },  
 113916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 114107: () => { return window.innerWidth; },  
 114133: () => { return window.innerHeight; },  
 114160: () => { if (document.fullscreenElement) return 1; },  
 114206: () => { return document.getElementById('canvas').width; },  
 114258: () => { return screen.width; },  
 114283: () => { document.exitFullscreen(); },  
 114310: () => { if (document.fullscreenElement) return 1; },  
 114356: () => { return document.getElementById('canvas').width; },  
 114408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114476: () => { document.exitFullscreen(); },  
 114503: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114561: () => { return screen.width; },  
 114586: () => { return screen.height; },  
 114612: () => { return window.screenX; },  
 114639: () => { return window.screenY; },  
 114666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114847: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115103: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115174: () => { if (document.fullscreenElement) return 1; },  
 115220: () => { return window.innerWidth; },  
 115246: () => { return window.innerHeight; },  
 115273: () => { if (document.pointerLockElement) return 1; }
};
