...
var ASM_CONSTS = {
  113040: () => { if (document.fullscreenElement) return 1; },  
 113086: () => { return document.getElementById('canvas').width; },  
 113138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113206: () => { document.exitFullscreen(); },  
 113233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113306: () => { if (document.fullscreenElement) return 1; },  
 113352: () => { return document.getElementById('canvas').width; },  
 113404: () => { return screen.width; },  
 113429: () => { document.exitFullscreen(); },  
 113456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113589: () => { return window.innerWidth; },  
 113615: () => { return window.innerHeight; },  
 113642: () => { if (document.fullscreenElement) return 1; },  
 113688: () => { return document.getElementById('canvas').width; },  
 113740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113808: () => { if (document.fullscreenElement) return 1; },  
 113854: () => { return document.getElementById('canvas').width; },  
 113906: () => { return screen.width; },  
 113931: () => { return window.innerWidth; },  
 113957: () => { return window.innerHeight; },  
 113984: () => { if (document.fullscreenElement) return 1; },  
 114030: () => { return document.getElementById('canvas').width; },  
 114082: () => { return screen.width; },  
 114107: () => { document.exitFullscreen(); },  
 114134: () => { if (document.fullscreenElement) return 1; },  
 114180: () => { return document.getElementById('canvas').width; },  
 114232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114300: () => { document.exitFullscreen(); },  
 114327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114385: () => { return screen.width; },  
 114410: () => { return screen.height; },  
 114436: () => { return window.screenX; },  
 114463: () => { return window.screenY; },  
 114490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 114998: () => { if (document.fullscreenElement) return 1; },  
 115044: () => { return window.innerWidth; },  
 115070: () => { return window.innerHeight; },  
 115097: () => { if (document.pointerLockElement) return 1; }
};
