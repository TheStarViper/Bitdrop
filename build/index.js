...
var ASM_CONSTS = {
  113712: () => { if (document.fullscreenElement) return 1; },  
 113758: () => { return document.getElementById('canvas').width; },  
 113810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113878: () => { document.exitFullscreen(); },  
 113905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113978: () => { if (document.fullscreenElement) return 1; },  
 114024: () => { return document.getElementById('canvas').width; },  
 114076: () => { return screen.width; },  
 114101: () => { document.exitFullscreen(); },  
 114128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 114261: () => { return window.innerWidth; },  
 114287: () => { return window.innerHeight; },  
 114314: () => { if (document.fullscreenElement) return 1; },  
 114360: () => { return document.getElementById('canvas').width; },  
 114412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114480: () => { if (document.fullscreenElement) return 1; },  
 114526: () => { return document.getElementById('canvas').width; },  
 114578: () => { return screen.width; },  
 114603: () => { return window.innerWidth; },  
 114629: () => { return window.innerHeight; },  
 114656: () => { if (document.fullscreenElement) return 1; },  
 114702: () => { return document.getElementById('canvas').width; },  
 114754: () => { return screen.width; },  
 114779: () => { document.exitFullscreen(); },  
 114806: () => { if (document.fullscreenElement) return 1; },  
 114852: () => { return document.getElementById('canvas').width; },  
 114904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114972: () => { document.exitFullscreen(); },  
 114999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 115057: () => { return screen.width; },  
 115082: () => { return screen.height; },  
 115108: () => { return window.screenX; },  
 115135: () => { return window.screenY; },  
 115162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 115215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 115286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 115343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115670: () => { if (document.fullscreenElement) return 1; },  
 115716: () => { return window.innerWidth; },  
 115742: () => { return window.innerHeight; },  
 115769: () => { if (document.pointerLockElement) return 1; }
};
