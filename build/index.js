...
var ASM_CONSTS = {
  113024: () => { if (document.fullscreenElement) return 1; },  
 113070: () => { return document.getElementById('canvas').width; },  
 113122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113190: () => { document.exitFullscreen(); },  
 113217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113290: () => { if (document.fullscreenElement) return 1; },  
 113336: () => { return document.getElementById('canvas').width; },  
 113388: () => { return screen.width; },  
 113413: () => { document.exitFullscreen(); },  
 113440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113573: () => { return window.innerWidth; },  
 113599: () => { return window.innerHeight; },  
 113626: () => { if (document.fullscreenElement) return 1; },  
 113672: () => { return document.getElementById('canvas').width; },  
 113724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113792: () => { if (document.fullscreenElement) return 1; },  
 113838: () => { return document.getElementById('canvas').width; },  
 113890: () => { return screen.width; },  
 113915: () => { return window.innerWidth; },  
 113941: () => { return window.innerHeight; },  
 113968: () => { if (document.fullscreenElement) return 1; },  
 114014: () => { return document.getElementById('canvas').width; },  
 114066: () => { return screen.width; },  
 114091: () => { document.exitFullscreen(); },  
 114118: () => { if (document.fullscreenElement) return 1; },  
 114164: () => { return document.getElementById('canvas').width; },  
 114216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114284: () => { document.exitFullscreen(); },  
 114311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 114369: () => { return screen.width; },  
 114394: () => { return screen.height; },  
 114420: () => { return window.screenX; },  
 114447: () => { return window.screenY; },  
 114474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 114982: () => { if (document.fullscreenElement) return 1; },  
 115028: () => { return window.innerWidth; },  
 115054: () => { return window.innerHeight; },  
 115081: () => { if (document.pointerLockElement) return 1; }
};
