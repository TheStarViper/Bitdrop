...
var ASM_CONSTS = {
  106256: () => { if (document.fullscreenElement) return 1; },  
 106302: () => { return document.getElementById('canvas').width; },  
 106354: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106422: () => { document.exitFullscreen(); },  
 106449: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106522: () => { if (document.fullscreenElement) return 1; },  
 106568: () => { return document.getElementById('canvas').width; },  
 106620: () => { return screen.width; },  
 106645: () => { document.exitFullscreen(); },  
 106672: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106805: () => { return window.innerWidth; },  
 106831: () => { return window.innerHeight; },  
 106858: () => { if (document.fullscreenElement) return 1; },  
 106904: () => { return document.getElementById('canvas').width; },  
 106956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107024: () => { if (document.fullscreenElement) return 1; },  
 107070: () => { return document.getElementById('canvas').width; },  
 107122: () => { return screen.width; },  
 107147: () => { return window.innerWidth; },  
 107173: () => { return window.innerHeight; },  
 107200: () => { if (document.fullscreenElement) return 1; },  
 107246: () => { return document.getElementById('canvas').width; },  
 107298: () => { return screen.width; },  
 107323: () => { document.exitFullscreen(); },  
 107350: () => { if (document.fullscreenElement) return 1; },  
 107396: () => { return document.getElementById('canvas').width; },  
 107448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107516: () => { document.exitFullscreen(); },  
 107543: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107601: () => { return screen.width; },  
 107626: () => { return screen.height; },  
 107652: () => { return window.screenX; },  
 107679: () => { return window.screenY; },  
 107706: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107759: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107830: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107887: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108143: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108214: () => { if (document.fullscreenElement) return 1; },  
 108260: () => { return window.innerWidth; },  
 108286: () => { return window.innerHeight; },  
 108313: () => { if (document.pointerLockElement) return 1; }
};
