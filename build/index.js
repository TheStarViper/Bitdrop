...
var ASM_CONSTS = {
  106352: () => { if (document.fullscreenElement) return 1; },  
 106398: () => { return document.getElementById('canvas').width; },  
 106450: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106518: () => { document.exitFullscreen(); },  
 106545: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106618: () => { if (document.fullscreenElement) return 1; },  
 106664: () => { return document.getElementById('canvas').width; },  
 106716: () => { return screen.width; },  
 106741: () => { document.exitFullscreen(); },  
 106768: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106901: () => { return window.innerWidth; },  
 106927: () => { return window.innerHeight; },  
 106954: () => { if (document.fullscreenElement) return 1; },  
 107000: () => { return document.getElementById('canvas').width; },  
 107052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107120: () => { if (document.fullscreenElement) return 1; },  
 107166: () => { return document.getElementById('canvas').width; },  
 107218: () => { return screen.width; },  
 107243: () => { return window.innerWidth; },  
 107269: () => { return window.innerHeight; },  
 107296: () => { if (document.fullscreenElement) return 1; },  
 107342: () => { return document.getElementById('canvas').width; },  
 107394: () => { return screen.width; },  
 107419: () => { document.exitFullscreen(); },  
 107446: () => { if (document.fullscreenElement) return 1; },  
 107492: () => { return document.getElementById('canvas').width; },  
 107544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107612: () => { document.exitFullscreen(); },  
 107639: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107697: () => { return screen.width; },  
 107722: () => { return screen.height; },  
 107748: () => { return window.screenX; },  
 107775: () => { return window.screenY; },  
 107802: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107855: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107926: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107983: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108239: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108310: () => { if (document.fullscreenElement) return 1; },  
 108356: () => { return window.innerWidth; },  
 108382: () => { return window.innerHeight; },  
 108409: () => { if (document.pointerLockElement) return 1; }
};
