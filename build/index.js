...
var ASM_CONSTS = {
  113696: () => { if (document.fullscreenElement) return 1; },  
 113742: () => { return document.getElementById('canvas').width; },  
 113794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113862: () => { document.exitFullscreen(); },  
 113889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113962: () => { if (document.fullscreenElement) return 1; },  
 114008: () => { return document.getElementById('canvas').width; },  
 114060: () => { return screen.width; },  
 114085: () => { document.exitFullscreen(); },  
 114112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 114245: () => { return window.innerWidth; },  
 114271: () => { return window.innerHeight; },  
 114298: () => { if (document.fullscreenElement) return 1; },  
 114344: () => { return document.getElementById('canvas').width; },  
 114396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114464: () => { if (document.fullscreenElement) return 1; },  
 114510: () => { return document.getElementById('canvas').width; },  
 114562: () => { return screen.width; },  
 114587: () => { return window.innerWidth; },  
 114613: () => { return window.innerHeight; },  
 114640: () => { if (document.fullscreenElement) return 1; },  
 114686: () => { return document.getElementById('canvas').width; },  
 114738: () => { return screen.width; },  
 114763: () => { document.exitFullscreen(); },  
 114790: () => { if (document.fullscreenElement) return 1; },  
 114836: () => { return document.getElementById('canvas').width; },  
 114888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114956: () => { document.exitFullscreen(); },  
 114983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 115041: () => { return screen.width; },  
 115066: () => { return screen.height; },  
 115092: () => { return window.screenX; },  
 115119: () => { return window.screenY; },  
 115146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 115199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 115270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 115327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 115654: () => { if (document.fullscreenElement) return 1; },  
 115700: () => { return window.innerWidth; },  
 115726: () => { return window.innerHeight; },  
 115753: () => { if (document.pointerLockElement) return 1; }
};
