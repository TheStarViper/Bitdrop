...
var ASM_CONSTS = {
  115352: () => { if (document.fullscreenElement) return 1; },  
 115398: () => { return document.getElementById('canvas').width; },  
 115450: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115518: () => { document.exitFullscreen(); },  
 115545: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 115618: () => { if (document.fullscreenElement) return 1; },  
 115664: () => { return document.getElementById('canvas').width; },  
 115716: () => { return screen.width; },  
 115741: () => { document.exitFullscreen(); },  
 115768: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 115901: () => { return window.innerWidth; },  
 115927: () => { return window.innerHeight; },  
 115954: () => { if (document.fullscreenElement) return 1; },  
 116000: () => { return document.getElementById('canvas').width; },  
 116052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116120: () => { if (document.fullscreenElement) return 1; },  
 116166: () => { return document.getElementById('canvas').width; },  
 116218: () => { return screen.width; },  
 116243: () => { return window.innerWidth; },  
 116269: () => { return window.innerHeight; },  
 116296: () => { if (document.fullscreenElement) return 1; },  
 116342: () => { return document.getElementById('canvas').width; },  
 116394: () => { return screen.width; },  
 116419: () => { document.exitFullscreen(); },  
 116446: () => { if (document.fullscreenElement) return 1; },  
 116492: () => { return document.getElementById('canvas').width; },  
 116544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116612: () => { document.exitFullscreen(); },  
 116639: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 116697: () => { return screen.width; },  
 116722: () => { return screen.height; },  
 116748: () => { return window.screenX; },  
 116775: () => { return window.screenY; },  
 116802: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 116855: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 116926: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 116983: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 117239: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 117310: () => { if (document.fullscreenElement) return 1; },  
 117356: () => { return window.innerWidth; },  
 117382: () => { return window.innerHeight; },  
 117409: () => { if (document.pointerLockElement) return 1; }
};
